...
The repeat attempts from one IP — especially targeting `root` — look like early brute-force probing that sysadmins typically monitor for.

🧠 Assessment

**Risk level:** Medium ⚠️ (demo)  

Even though this was a handcrafted dataset, it mimics real SSH brute-force behavior — multiple failed attempts from the same IP and privileged-account targeting. These patterns would usually trigger tools like `fail2ban` or IP-based blocking.

💡 Recommendations

* Disable direct root SSH login (`PermitRootLogin no` in `/etc/ssh/sshd_config`).  
* Use SSH key authentication instead of passwords.  
* Install `fail2ban` or similar to block repeat offenders automatically.  
...
* [Screenshot 700](https://github.com/MallikaKundeti/My-Cyber-projects/blob/main/ssh-log-hunt/screenshots/Screenshot-700.png)  
* [Screenshot 701](https://github.com/MallikaKundeti/My-Cyber-projects/blob/main/ssh-log-hunt/screenshots/Screenshot-701.png)
